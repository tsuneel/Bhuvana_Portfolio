				...
				<div className='flex flex-col md:flex-row items-center gap-12'>
					...
					<div className='md:w-1/2'>
						<p className='text-lg text-gray-600 mb-6'>
							...
							frontend and backend technologies. With a strong foundation in
							React, JavaScript, and Java Spring Boot, I create robust and
							scalable web applications that deliver exceptional user
							experiences.
						</p>
						<p className='text-lg text-gray-600 mb-6'>
							My journey in software development started with a deep curiosity
							for building things from scratch. Today, I combine my technical
							skills with creative problem-solving to develop solutions that
							make a real impact.
						</p>
