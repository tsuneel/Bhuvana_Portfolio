...
export const Achievements = () => {
  ...
  return (
    <section className="py-12 px-4 bg-gray-900" id="achievements">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-8 text-center text-white">📜 Certifications</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
          {certificates.map((cert, index) => (
            <div key={index} className="bg-gray-200 rounded-2xl shadow-md p-4 hover:shadow-lg transition-all w-full max-w-sm">
              <img
                src={cert.image}
                alt={cert.title}
